        ...
        <div className={styles.container}>
            <section className={styles.formContainer}>
                ...
                <form onSubmit={handleForm} className={styles.form}>
                    ...
                    <button type="submit" className={styles.formButton}>Inscreva-se</button>
                    <button type="button" className={styles.formButton} onClick={() => router.push("/signIn")}>Entrar</button>
                </form>
            </section>
        </div>
    );
